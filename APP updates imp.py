...
def initialize_dataset():
    ...
    try:
        ...
        st.error(f"**Permission Denied:** The file at `{DATASET_PATH}` is currently open in Excel or another program. Please close it and refresh this page!")
        return
    except Exception:
        try:
    ...
    try:
        ...
        st.error(f"**Permission Denied:** Cannot create or write to `{DATASET_PATH}`. Please check if the folder is locked or open in another program.")
